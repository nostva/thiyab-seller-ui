...
import { ChannelCodeLabel } from '@/components/shared/channel-code-label'
import {
  DropdownMenu,
  DropdownMenuContent,
  DropdownMenuItem,
...
export function ChannelSwitcher() {
  ...
  const { channels, activeChannel, selectedChannel, setSelectedChannel } =
    useChannel()
            ...
            >
              ...
              <div className="grid flex-1 text-left text-sm leading-tight">
                ...
                <span className="truncate text-xs">
                  Default Language:{' '}
                  {displayChannel?.defaultLanguageCode?.toUpperCase()}
                </span>
              </div>
