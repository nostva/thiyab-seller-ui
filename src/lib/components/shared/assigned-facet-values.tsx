...
import { FacetValueChip } from './facet-value-chip'
import { FacetValueSelector } from './facet-value-selector'
...
export function AssignedFacetValues({
  ...
  const [knownFacetValues, setKnownFacetValues] =
    useState<FacetValue[]>(facetValues)
