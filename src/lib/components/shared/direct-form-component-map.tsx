import type { DefaultFormComponentId } from '@vendure/common/lib/shared-types'
import React from 'react'

import { AffixedInput } from '@/components/data-input/affixed-input.js'
import { CombinationModeInput } from '@/components/data-input/combination-mode-input.js'
import { DateTimeInput } from '@/components/data-input/datetime-input.js'
import { DefaultRelationInput } from '@/components/data-input/default-relation-input.js'
...
import { ProductMultiInput } from '@/components/data-input/product-multi-selector.js'
import { RichTextInput } from '@/components/data-input/rich-text-input.js'
...
import type { UniversalFieldDefinition } from './universal-field-definition.js'
import { transformValue, type ValueMode } from './value-transformers.js'
 ...
 */
const TextFormInput: React.FC<DirectFormComponentProps> = ({
  field,
  disabled,
  fieldDef,
  valueMode,
 ...
 */
const NumberFormInput: React.FC<DirectFormComponentProps> = ({
  field,
  disabled,
  fieldDef,
  valueMode,
 ...
 */
const BooleanFormInput: React.FC<DirectFormComponentProps> = ({
  field,
  disabled,
  fieldDef,
  valueMode,
 ...
 */
const CurrencyFormInput: React.FC<DirectFormComponentProps> = ({
  field,
  disabled,
  fieldDef,
  valueMode,
}) => {
  const { transformedValue, handleChange } = useValueTransformation(
    field,
    fieldDef,
    valueMode,
  )
 ...
 * Date input wrapper
 */
const DateFormInput: React.FC<DirectFormComponentProps> = ({
  field,
  disabled,
  fieldDef,
  valueMode,
 ...
 */
const SelectFormInput: React.FC<DirectFormComponentProps> = ({
  field,
  disabled,
  fieldDef,
  valueMode,
 ...
 */
const TextareaFormInput: React.FC<DirectFormComponentProps> = ({
  field,
  disabled,
  fieldDef,
  valueMode,
...
const ProductSelectorFormInput: React.FC<DirectFormComponentProps> = ({
  ...
  const entityType =
    fieldDef.ui?.selectionMode === 'variant' ? 'ProductVariant' : 'Product'
 ...
 */
const PasswordFormInput: React.FC<DirectFormComponentProps> = ({
  field,
  disabled,
  fieldDef,
  valueMode,
 ...
 */
export const DIRECT_FORM_COMPONENT_MAP: Record<
  DefaultFormComponentId,
  React.FC<DirectFormComponentProps>
> = {
