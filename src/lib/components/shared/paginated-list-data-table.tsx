...
import { getObjectPathToPaginatedList } from '@/framework/document-introspection/get-document-structure.js'
...
>({
  ...
  const paginatedListObjectPath =
    getObjectPathToPaginatedList(extendedListQuery)
