...
class GlobalRegistry {
  ...
  public register<T extends GlobalRegistryKey>(
    key: T,
    value: GlobalRegistryContents[T],
  ) {
...
const _globalRegistry: GlobalRegistry =
  (globalThis as any).globalRegistry ?? new GlobalRegistry()
