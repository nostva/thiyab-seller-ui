...
} from '@/components/data-display/boolean.js'
...
import type { DataDisplayComponent } from '../component-registry/component-registry.js'
import { globalRegistry } from '../registry/global-registry.js'

globalRegistry.register(
  'displayComponents',
  new Map<string, DataDisplayComponent>(),
)

// Create component function for asset display
const AssetDisplay: DataDisplayComponent = ({ value }) => (
 ...
 */
export function generateDisplayComponentKey(
  pageId: string,
  blockId: string,
  field: string,
): string {
...
export function addDisplayComponent({
  ...
  if (displayComponents.has(key)) {
    ...
    console.warn(
      `Display component with key "${key}" is already registered and will be overwritten.`,
    )
  }
