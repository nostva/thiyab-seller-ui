...
import type { DataInputComponent } from '../component-registry/component-registry.js'
import { globalRegistry } from '../registry/global-registry.js'

globalRegistry.register(
  'inputComponents',
  new Map<string, DataInputComponent>(),
)
 ...
 */
export function generateInputComponentKey(
  pageId: string,
  blockId: string,
  field: string,
): string {
...
export function addInputComponent({
  ...
  if (inputComponents.has(key)) {
    ...
    console.warn(
      `Input component with key "${key}" is already registered and will be overwritten.`,
    )
  }
