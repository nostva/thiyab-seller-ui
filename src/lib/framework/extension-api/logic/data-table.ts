...
import type { DashboardDataTableExtensionDefinition } from '../types/index.js'
 ...
 */
export function generateDataTableDisplayComponentKey(
  pageId: string,
  column: string,
): string {
...
export function registerDataTableExtensions(
