import { graphql, type ResultOf } from './graphql.js'
...
export type ConfigurableOperationFragment = ResultOf<
  typeof configurableOperationFragment
>
...
export type ConfigurableOperationDefFragment = ResultOf<
  typeof configurableOperationDefFragment
>
