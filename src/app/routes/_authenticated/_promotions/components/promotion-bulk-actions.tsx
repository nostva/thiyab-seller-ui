...
export const DeletePromotionsBulkAction: BulkActionComponent<any> = ({
  selection,
  table,
}) => {
  return (
...
export const AssignPromotionsToChannelBulkAction: BulkActionComponent<any> = ({
  selection,
  table,
}) => {
  return (
...
export const RemovePromotionsFromChannelBulkAction: BulkActionComponent<
  any
> = ({ selection, table }) => {
...
export const DuplicatePromotionsBulkAction: BulkActionComponent<any> = ({
  selection,
  table,
}) => {
  return (
