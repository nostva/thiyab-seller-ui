...
export function FulfillmentHandlerSelector({
  value,
  onChange,
}: Readonly<FulfillmentHandlerSelectorProps>) {
  ...
  return (
    <div>
      <Select
        onValueChange={onFulfillmentHandlerSelected}
      ...
      >
        ...
        <SelectContent>
          {fulfillmentHandlers?.map((fulfillmentHandler) => (
            <SelectItem
              key={fulfillmentHandler.code}
              value={fulfillmentHandler.code}
            >
