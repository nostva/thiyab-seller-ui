...
} from './components/state-transition-control.js'
...
import {
  canAddFulfillment,
  shouldShowAddManualPaymentButton,
  ...
  return (
    ...
    >
      ...
      <PageLayout>
        ...
        <PageBlock
          column="main"
          blockId="payment-details"
          title={<Trans>Payment details</Trans>}
        >
        ...
        <PageBlock
          ...
          title={<Trans>Order history</Trans>}
        >
