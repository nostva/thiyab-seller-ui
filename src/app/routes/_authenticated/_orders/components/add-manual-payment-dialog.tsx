...
} from '@/components/data-input/relation-selector.js'
    ...
    <>
      ...
      >
        <Trans>
          ...
          {formatCurrency(outstandingAmount, currencyCode)})
        </Trans>
      </Button>
      <Dialog open={open}>
            ...
            >
              ...
              <FormFieldWrapper
                ...
                render={({ field }) => (
                  <Input
                    {...field}
                    placeholder={i18n.t('Enter transaction ID')}
                  />
                )}
              />
              <DialogFooter>
