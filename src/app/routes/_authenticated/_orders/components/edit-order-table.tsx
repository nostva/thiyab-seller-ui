import { SingleRelationInput } from '@/components/data-input/relation-input.js'
...
export function EditOrderTable({
  ...
  const columns: ColumnDef<
    OrderLineFragment & { customFields?: Record<string, any> }
  >[] = [
    {
      header: 'Image',
                ...
                <div className="my-4 flex justify-center">
                  <div className="max-w-lg">
                    <ProductVariantSelector
                      onProductVariantSelect={onAddItem}
                    />
                  </div>
                </div>
              </TableCell>
              ...
              <TableCell colSpan={columns.length} className="h-12">
                <ShippingMethodSelector
                  ...
                  onSelect={(shippingMethodId) =>
                    onSetShippingMethod({ shippingMethodId })
                  }
                />
              </TableCell>
            </TableRow>
