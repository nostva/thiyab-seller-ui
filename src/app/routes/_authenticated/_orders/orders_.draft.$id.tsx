...
export const Route = createFileRoute(
  ...
  loader: async ({ context, params }) => {
    ...
    const result: ResultOf<typeof orderDetailDocument> =
      await context.queryClient.ensureQueryData(
        getDetailQueryOptions(addCustomFields(orderDetailDocument), {
          id: params.id,
        }),
        { id: params.id },
      )
...
function DraftOrderPage() {
  ...
  const { data: eligibleShippingMethods } = useQuery({
    ...
    queryFn: () =>
      api.query(draftOrderEligibleShippingMethodsDocument, {
        orderId: entity?.id ?? '',
      }),
  ...
  const { mutate: setShippingAddressForDraftOrder } = useMutation({
    ...
    onSuccess: (
      result: ResultOf<typeof setShippingAddressForDraftOrderDocument>,
    ) => {
  ...
  const { mutate: setBillingAddressForDraftOrder } = useMutation({
    ...
    onSuccess: (
      result: ResultOf<typeof setBillingAddressForDraftOrderDocument>,
    ) => {
  ...
  const { mutate: unsetShippingAddressForDraftOrder } = useMutation({
    ...
    onSuccess: (
      result: ResultOf<typeof unsetShippingAddressForDraftOrderDocument>,
    ) => {
  ...
  const { mutate: unsetBillingAddressForDraftOrder } = useMutation({
    ...
    onSuccess: (
      result: ResultOf<typeof unsetBillingAddressForDraftOrderDocument>,
    ) => {
  ...
  const { mutate: setShippingMethodForDraftOrder } = useMutation({
    ...
    onSuccess: (
      result: ResultOf<typeof setDraftOrderShippingMethodDocument>,
    ) => {
  ...
  const { mutate: setCouponCodeForDraftOrder } = useMutation({
    ...
    onSuccess: (
      result: ResultOf<typeof applyCouponCodeToDraftOrderDocument>,
    ) => {
  ...
  const { mutate: removeCouponCodeForDraftOrder } = useMutation({
    ...
    onSuccess: (
      result: ResultOf<typeof removeCouponCodeFromDraftOrderDocument>,
    ) => {
  ...
  const { mutate: completeDraftOrder } = useMutation({
    ...
    onSuccess: async (
      result: ResultOf<typeof transitionOrderToStateDocument>,
    ) => {
  ...
  return (
    <Page pageId="draft-order-detail" form={form}>
        ...
        <PageActionBarRight>
          ...
          <PermissionGuard requires={['UpdateOrder']}>
            <Button
              ...
              onClick={() =>
                completeDraftOrder({ id: entity.id, state: 'ArrangingPayment' })
              }
            >
      ...
      <PageLayout>
        ...
        <PageBlock
          column="side"
          blockId="shipping-address"
          title={<Trans>Shipping address</Trans>}
        >
