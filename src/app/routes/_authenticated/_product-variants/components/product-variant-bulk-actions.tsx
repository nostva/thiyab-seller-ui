...
export const DeleteProductVariantsBulkAction: BulkActionComponent<any> = ({
  selection,
  table,
}) => {
  return (
...
export const AssignProductVariantsToChannelBulkAction: BulkActionComponent<
  any
> = ({ selection, table }) => {
...
export const RemoveProductVariantsFromChannelBulkAction: BulkActionComponent<
  any
> = ({ selection, table }) => {
...
export const AssignFacetValuesToProductVariantsBulkAction: BulkActionComponent<
  any
> = ({ selection, table }) => {
  ...
  return (
    <>
      ...
      <AssignFacetValuesDialog
        ...
        entityType="variants"
        queryFn={(variables) =>
          api.query(getProductVariantsWithFacetValuesByIdsDocument, variables)
        }
