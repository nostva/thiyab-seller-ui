...
export const DeleteProductsBulkAction: BulkActionComponent<any> = ({
  selection,
  table,
}) => {
  return (
...
export const AssignProductsToChannelBulkAction: BulkActionComponent<any> = ({
  selection,
  table,
}) => {
...
export const RemoveProductsFromChannelBulkAction: BulkActionComponent<any> = ({
  selection,
  table,
}) => {
...
export const AssignFacetValuesToProductsBulkAction: BulkActionComponent<
  any
> = ({ selection, table }) => {
  ...
  return (
    <>
      ...
      <AssignFacetValuesDialog
        ...
        entityType="products"
        queryFn={(variables) =>
          api.query(getProductsWithFacetValuesByIdsDocument, variables)
        }
...
export const DuplicateProductsBulkAction: BulkActionComponent<any> = ({
  selection,
  table,
}) => {
  return (
