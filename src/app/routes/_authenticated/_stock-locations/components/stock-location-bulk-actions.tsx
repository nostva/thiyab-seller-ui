...
export const DeleteStockLocationsBulkAction: BulkActionComponent<any> = ({
  selection,
  table,
}) => {
  return (
...
export const AssignStockLocationsToChannelBulkAction: BulkActionComponent<
  any
> = ({ selection, table }) => {
  return (
...
export const RemoveStockLocationsFromChannelBulkAction: BulkActionComponent<
  any
> = ({ selection, table }) => {
