...
export const DeletePaymentMethodsBulkAction: BulkActionComponent<any> = ({
  selection,
  table,
}) => {
  return (
...
export const AssignPaymentMethodsToChannelBulkAction: BulkActionComponent<
  any
> = ({ selection, table }) => {
  return (
...
export const RemovePaymentMethodsFromChannelBulkAction: BulkActionComponent<
  any
> = ({ selection, table }) => {
