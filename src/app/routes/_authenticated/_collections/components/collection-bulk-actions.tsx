...
export const AssignCollectionsToChannelBulkAction: BulkActionComponent<any> = ({
  selection,
  table,
}) => {
...
export const RemoveCollectionsFromChannelBulkAction: BulkActionComponent<
  any
> = ({ selection, table }) => {
...
export const DuplicateCollectionsBulkAction: BulkActionComponent<any> = ({
  selection,
  table,
}) => {
  const queryClient = useQueryClient()
...
export const DeleteCollectionsBulkAction: BulkActionComponent<any> = ({
  selection,
  table,
}) => {
  return (
...
export const MoveCollectionsBulkAction: BulkActionComponent<any> = ({
  selection,
  table,
}) => {
