...
import { type FetchQueryOptions, useQueries } from '@tanstack/react-query'
...
type Collection = ResultOf<
  typeof collectionListDocument
            ...
            cell: ({ row }) => {
              ...
              return (
                <div
                  style={{
                    marginLeft:
                      (row.original.breadcrumbs.length - 2) * 20 + 'px',
                  }}
          ...
          productVariants: {
            ...
            cell: ({ row }) => {
              return (
                ...
                >
                  <Trans>
                    {row.original.productVariants.totalItems} variants
                  </Trans>
                </CollectionContentsSheet>
              )
            },
