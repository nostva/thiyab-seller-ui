      ...
      <PageLayout>
        <PageBlock column="side" blockId="privacy">
          <FormFieldWrapper
            ...
            description={
              <Trans>Private collections are not visible in the shop</Trans>
            }
            render={({ field }) => (
          ...
          <FormFieldWrapper
            ...
            description={
              <Trans>
                ...
                collection and combined with the filters set on this collection.
              </Trans>
            }
            render={({ field }) => (
              <Switch checked={field.value} onCheckedChange={field.onChange} />
            ...
            <FormControl>
              <EntityAssets
                ...
                onChange={(value) => {
                  form.setValue(
                    'featuredAssetId',
                    value.featuredAssetId ?? undefined,
                    {
                      shouldDirty: true,
                      shouldValidate: true,
                    },
