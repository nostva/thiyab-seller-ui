...
} from './global-settings.graphql.js'
...
export const Route = createFileRoute(
  ...
  loader: async ({ context }) => {
    ...
    return {
      breadcrumb: [
        { path: '/global-settings', label: <Trans>Global settings</Trans> },
      ],
    }
  },
  ...
  return (
    ...
    >
      ...
      <PageActionBar>
        <PageActionBarRight>
          <PermissionGuard
            requires={['UpdateSettings', 'UpdateGlobalSettings']}
          >
            <Button
              type="submit"
              disabled={
        ...
        <PageBlock column="main" blockId="main-form">
          <DetailFormGrid>
            <FormFieldWrapper
              ...
              description={
                <Trans>
                  Sets the languages that are available for all channels.
                  Individual channels can then support a subset of these
                  languages.
                </Trans>
              }
              render={({ field }) => (
            ...
            <FormFieldWrapper
              ...
              description={
                <Trans>
                  Sets the stock level at which this a variant is considered to
                  be out of stock. Using a negative value enables backorder
                  support. Can be overridden by product variants.
                </Trans>
              }
              render={({ field }) => (
                <Input
